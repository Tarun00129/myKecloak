...
function applicationRoutes() {
    ...
    app.get('/checkPermission', (req, res) => {
        keyCloak.validateAccessToken(req.kauth.grant.access_token.token)
            .then(() => {
                const permission = {
                    resource: 'res:customer',
                    scopes: ['scopes:create']
                };
                return keyCloak.checkPermission(req, permission);
            })
