...
1. Enter credentials (it was specified in the `docker-compose.yml`)
2. Go to the Keycloak administration console [http://localhost:8080/admin/realms](http://localhost:8080/admin/realms)
...
5. After `Sign in`, `CAMPAIGN_REALM` has to be created. Go to the `Clients` menu.
